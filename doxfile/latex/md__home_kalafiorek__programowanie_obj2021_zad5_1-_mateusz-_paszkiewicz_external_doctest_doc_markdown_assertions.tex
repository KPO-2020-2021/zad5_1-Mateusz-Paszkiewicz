...
Using the \href{configuration.md\#doctest_config_super_fast_asserts}{\texttt{ $\ast$$\ast${\ttfamily D\+O\+C\+T\+E\+S\+T\+\_\+\+C\+O\+N\+F\+I\+G\+\_\+\+S\+U\+P\+E\+R\+\_\+\+F\+A\+S\+T\+\_\+\+A\+S\+S\+E\+R\+TS}$\ast$$\ast$}} config option can make the binary asserts to compile up to \href{benchmarks.md\#cost-of-an-assertion-macro}{\texttt{ {\bfseries{84-\/91\%}}}} faster!\hypertarget{md__home_kalafiorek__programowanie_obj2021_zad5_1-_mateusz-_paszkiewicz_external_doctest_doc_markdown_assertions_autotoc_md43}{}\doxysection{Exceptions}\label{md__home_kalafiorek__programowanie_obj2021_zad5_1-_mateusz-_paszkiewicz_external_doctest_doc_markdown_assertions_autotoc_md43}
...
Currently $\ast$$\ast$logging macros$\ast$$\ast$ cannot be used for extra context for asserts outside of a test run. That means that the {\ttfamily \+\_\+\+M\+E\+S\+S\+A\+GE} variants of asserts are also not usable -\/ since they are just a packed {\ttfamily I\+N\+F\+O()} with an assert right after it.\hypertarget{md__home_kalafiorek__programowanie_obj2021_zad5_1-_mateusz-_paszkiewicz_external_doctest_doc_markdown_assertions_autotoc_md45}{}\doxysection{Floating point comparisons}\label{md__home_kalafiorek__programowanie_obj2021_zad5_1-_mateusz-_paszkiewicz_external_doctest_doc_markdown_assertions_autotoc_md45}
